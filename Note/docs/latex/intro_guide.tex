...
\item \doxylink{group__init_ga7b57ba0946498e8621f4d969bbcecfba}{glfw\+Platform\+Supported}
...
\item \doxylink{group__init_ga0f4c8556a21d9e774a0ba0332da1748e}{glfw\+Init\+Allocator}
\item \doxylink{init_8c_a1712210f34c339a05adda69e3587ec00}{glfw\+Init\+Vulkan\+Loader}
...
@macos When the library is initialized the main menu and dock icon are created. These are not desirable for a command-\/line only program. The creation of the main menu and dock icon can be disabled with the \doxylink{group__init_ga71e0b4ce2f2696a84a9b8c5e12dc70cf}{GLFW\+\_\+\+COCOA\+\_\+\+MENUBAR} init hint.\hypertarget{intro_guide_init_hints}{}\doxysubsection{\texorpdfstring{Initialization hints}{Initialization hints}}\label{intro_guide_init_hints}
...
{\bfseries{GLFW\+\_\+\+PLATFORM}} specifies the platform to use for windowing and input. Possible values are {\ttfamily GLFW\+\_\+\+ANY\+\_\+\+PLATFORM}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+WIN32}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+COCOA}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+WAYLAND}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+X11} and {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+NULL}. The default value is {\ttfamily GLFW\+\_\+\+ANY\+\_\+\+PLATFORM}, which will choose any platform the library includes support for except for the Null backend.

\label{intro_guide_GLFW_JOYSTICK_HAT_BUTTONS}%
\Hypertarget{intro_guide_GLFW_JOYSTICK_HAT_BUTTONS}%
{\bfseries{GLFW\+\_\+\+JOYSTICK\+\_\+\+HAT\+\_\+\+BUTTONS}} specifies whether to also expose joystick hats as buttons, for compatibility with earlier versions of GLFW that did not have \doxylink{group__input_gaf0f00897c4d010af7bd1aea1f6193e6f}{glfw\+Get\+Joystick\+Hats}. Possible values are {\ttfamily GLFW\+\_\+\+TRUE} and {\ttfamily GLFW\+\_\+\+FALSE}.
...
{\bfseries{GLFW\+\_\+\+COCOA\+\_\+\+MENUBAR}} specifies whether to create the menu bar and dock icon when GLFW is initialized. This applies whether the menu bar is created from a nib or manually by GLFW. Possible values are {\ttfamily GLFW\+\_\+\+TRUE} and {\ttfamily GLFW\+\_\+\+FALSE}. This is ignored on other platforms.\hypertarget{intro_guide_init_hints_wayland}{}\doxysubsubsection{\texorpdfstring{Wayland specific init hints}{Wayland specific init hints}}\label{intro_guide_init_hints_wayland}
\label{intro_guide_GLFW_WAYLAND_LIBDECOR_hint}%
\Hypertarget{intro_guide_GLFW_WAYLAND_LIBDECOR_hint}%
{\bfseries{GLFW\+\_\+\+WAYLAND\+\_\+\+LIBDECOR}} specifies whether to use \href{https://gitlab.freedesktop.org/libdecor/libdecor}{\texttt{ libdecor}} for window decorations where available. Possible values are {\ttfamily GLFW\+\_\+\+WAYLAND\+\_\+\+PREFER\+\_\+\+LIBDECOR} and {\ttfamily GLFW\+\_\+\+WAYLAND\+\_\+\+DISABLE\+\_\+\+LIBDECOR}. This is ignored on other platforms.\hypertarget{intro_guide_init_hints_x11}{}\doxysubsubsection{\texorpdfstring{X11 specific init hints}{X11 specific init hints}}\label{intro_guide_init_hints_x11}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Initialization hint   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Default value   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Supported values    }\\\cline{1-3}
\endhead
\doxylink{intro_guide_GLFW_PLATFORM}{GLFW\+\_\+\+PLATFORM}   &{\ttfamily GLFW\+\_\+\+ANY\+\_\+\+PLATFORM}   &{\ttfamily GLFW\+\_\+\+ANY\+\_\+\+PLATFORM}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+WIN32}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+COCOA}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+WAYLAND}, {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+X11} or {\ttfamily GLFW\+\_\+\+PLATFORM\+\_\+\+NULL}    \\\cline{1-3}
...
\doxylink{group__init_ga2a3f2fd7695902c498b050215b3db452}{GLFW\+\_\+\+WAYLAND\+\_\+\+LIBDECOR}   &{\ttfamily GLFW\+\_\+\+WAYLAND\+\_\+\+PREFER\+\_\+\+LIBDECOR}   &{\ttfamily GLFW\+\_\+\+WAYLAND\+\_\+\+PREFER\+\_\+\+LIBDECOR} or {\ttfamily GLFW\+\_\+\+WAYLAND\+\_\+\+DISABLE\+\_\+\+LIBDECOR}    \\\cline{1-3}
\doxylink{group__init_gaa341e303ebeb8e4199b8ab8be84351f6}{GLFW\+\_\+\+X11\+\_\+\+XCB\+\_\+\+VULKAN\+\_\+\+SURFACE}   &{\ttfamily GLFW\+\_\+\+TRUE}   &{\ttfamily GLFW\+\_\+\+TRUE} or {\ttfamily GLFW\+\_\+\+FALSE}   \\\cline{1-3}
\end{longtabu}
\hypertarget{intro_guide_platform}{}\doxysubsection{\texorpdfstring{Runtime platform selection}{Runtime platform selection}}\label{intro_guide_platform}
...
You can control platform selection via the \doxylink{intro_guide_GLFW_PLATFORM}{GLFW\+\_\+\+PLATFORM} initialization hint. By default, this is set to \doxylink{group__init_ga18b2d37374d0dea28cd69194fa85b859}{GLFW\+\_\+\+ANY\+\_\+\+PLATFORM}, which will look for supported window systems in order of priority and select the first one it finds. It can also be set to any specific platform to have GLFW only look for that one.
...
You can test whether a library binary was compiled with support for a specific platform with \doxylink{group__init_ga7b57ba0946498e8621f4d969bbcecfba}{glfw\+Platform\+Supported}.
...
Once GLFW has been initialized, you can query which platform was selected with \doxylink{group__init_gac2d1735162a981fcaa8fb386740aa5ce}{glfw\+Get\+Platform}.
...
If you are using any \doxylink{group__native}{native access functions}, especially on Linux and other Unix-\/like systems, then you may need to check that you are calling the ones matching the selected platform.\hypertarget{intro_guide_init_allocator}{}\doxysubsection{\texorpdfstring{Custom heap memory allocator}{Custom heap memory allocator}}\label{intro_guide_init_allocator}
The heap memory allocator can be customized before initialization with \doxylink{group__init_ga0f4c8556a21d9e774a0ba0332da1748e}{glfw\+Init\+Allocator}.


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{structGLFWallocator}{GLFWallocator}}\ allocator;}
\DoxyCodeLine{allocator.\mbox{\hyperlink{structGLFWallocator_a18a798136f17a9cb105be18312193bf7}{allocate}}\ =\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{my\_malloc}};}
\DoxyCodeLine{allocator.\mbox{\hyperlink{structGLFWallocator_af5a674af9e170095b968f467233437be}{reallocate}}\ =\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{my\_realloc}};}
\DoxyCodeLine{allocator.\mbox{\hyperlink{structGLFWallocator_ab74cf9a969e73e6eb65a6112a591a988}{deallocate}}\ =\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{my\_free}};}
\DoxyCodeLine{allocator.\mbox{\hyperlink{structGLFWallocator_af6153be74dbaf7f0a7e8bd3bfc039910}{user}}\ =\ \mbox{\hyperlink{tinycthread_8c_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}};}
\DoxyCodeLine{}
...
The allocation function must have a signature matching \doxylink{group__init_ga4306a564e9f60f4de8cc8f31731a3120}{GLFWallocatefun}. It receives the desired size, in bytes, and the user pointer passed to \doxylink{group__init_ga0f4c8556a21d9e774a0ba0332da1748e}{glfw\+Init\+Allocator} and returns the address to the allocated memory block.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{my\_malloc}}(\textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a3d1e3edfcf61ca2d831883e1afbad89e}{size}},\ \textcolor{keywordtype}{void}*\ user)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
...
The documentation for \doxylink{group__init_ga4306a564e9f60f4de8cc8f31731a3120}{GLFWallocatefun} also lists the requirements and limitations for an allocation function. If the active one does not meet all of these, GLFW may fail.

The reallocation function must have a function signature matching \doxylink{group__init_ga3e88a829615d8efe8bec1746f7309c63}{GLFWreallocatefun}. It receives the memory block to be reallocated, the new desired size, in bytes, and the user pointer passed to \doxylink{group__init_ga0f4c8556a21d9e774a0ba0332da1748e}{glfw\+Init\+Allocator} and returns the address to the resized memory block.
...
The documentation for \doxylink{group__init_ga3e88a829615d8efe8bec1746f7309c63}{GLFWreallocatefun} also lists the requirements and limitations for a reallocation function. If the active one does not meet all of these, GLFW may fail.

The deallocation function must have a function signature matching \doxylink{group__init_ga7181615eda94c4b07bd72bdcee39fa28}{GLFWdeallocatefun}. It receives the memory block to be deallocated and the user pointer passed to \doxylink{group__init_ga0f4c8556a21d9e774a0ba0332da1748e}{glfw\+Init\+Allocator}.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{my\_free}}(\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{block}},\ \textcolor{keywordtype}{void}*\ user)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
...
The documentation for \doxylink{group__init_ga7181615eda94c4b07bd72bdcee39fa28}{GLFWdeallocatefun} also lists the requirements and limitations for a deallocation function. If the active one does not meet all of these, GLFW may fail.\hypertarget{intro_guide_intro_init_terminate}{}\doxysubsection{\texorpdfstring{Terminating GLFW}{Terminating GLFW}}\label{intro_guide_intro_init_terminate}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{handle\_error}}(code);}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{display\_error\_message}}(code,\ description);}
...
\begin{DoxyItemize}
\item \doxylink{group__init_ga7b57ba0946498e8621f4d969bbcecfba}{glfw\+Platform\+Supported}
\item \doxylink{group__init_gac2d1735162a981fcaa8fb386740aa5ce}{glfw\+Get\+Platform}
\end{DoxyItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{printf}}(\textcolor{stringliteral}{"{}Compiled\ against\ GLFW\ \%i.\%i.\%i\(\backslash\)n"{}},}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{printf}}(\textcolor{stringliteral}{"{}Running\ against\ GLFW\ \%i.\%i.\%i\(\backslash\)n"{}},\ major,\ minor,\ revision);}
...
{\bfseries{GLFW 3.\+4\+:}} The format of this string was changed to support the addition of \doxysectlink{intro_guide_platform}{runtime platform selection}{2}.
...
For example, compiling GLFW 3.\+5 with Min\+GW as a DLL for Windows, may result in a version string like this\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{3.5.0\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{Win32}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{WGL}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{Null}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{EGL}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{OSMesa}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{MinGW}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{DLL}}}
