...
The internal interface is in charge of GLFW\textquotesingle{}s global data, which it stores in a {\ttfamily \doxylink{struct__GLFWlibrary}{\+\_\+\+GLFWlibrary}} struct named {\ttfamily \+\_\+glfw}.

The internal interface uses the same style as the public interface, except all global names have a leading underscore.

Examples\+: {\ttfamily \+\_\+glfw\+Is\+Valid\+Context\+Config}, {\ttfamily \doxylink{struct__GLFWwindow}{\+\_\+\+GLFWwindow}}, {\ttfamily \+\_\+glfw.\+monitor\+Count}\hypertarget{internals_guide_internals_platform}{}\doxysection{\texorpdfstring{Platform interface}{Platform interface}}\label{internals_guide_internals_platform}
...
Examples\+: {\ttfamily \doxylink{struct__GLFWwindowX11}{\+\_\+\+GLFWwindow\+X11}}, {\ttfamily \doxylink{struct__GLFWcontextWGL}{\+\_\+\+GLFWcontext\+WGL}}
