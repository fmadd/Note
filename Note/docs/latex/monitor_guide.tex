...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__monitor_ga8d9efd1cde9426692c73fe40437d0ae3}{GLFWmonitor}}*\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{primary}}\ =\ \mbox{\hyperlink{group__monitor_ga34befff4f9f0fae09dd8de6fb0eb4f3e}{glfwGetPrimaryMonitor}}();}
...
\DoxyCodeLine{\mbox{\hyperlink{group__monitor_ga8d9efd1cde9426692c73fe40437d0ae3}{GLFWmonitor}}**\ monitors\ =\ \mbox{\hyperlink{group__monitor_ga8c78e5db186ee10d00c053faf81998af}{glfwGetMonitors}}(\&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a619bc20e8198de3bd3f3d7fc34de66b2}{count}});}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ monitor\_callback(\mbox{\hyperlink{group__monitor_ga8d9efd1cde9426692c73fe40437d0ae3}{GLFWmonitor}}*\ monitor,\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{event}})}
\DoxyCodeLine{\{}
...
Video modes are represented as \doxylink{structGLFWvidmode}{GLFWvidmode} structures. You can get an array of the video modes supported by a monitor with \doxylink{group__monitor_ga7eaea6132f15e9b5d47eb94f88547f79}{glfw\+Get\+Video\+Modes}. See the reference documentation for the lifetime of the returned array.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a619bc20e8198de3bd3f3d7fc34de66b2}{count}};}
\DoxyCodeLine{\mbox{\hyperlink{structGLFWvidmode}{GLFWvidmode}}*\ modes\ =\ \mbox{\hyperlink{group__monitor_ga7eaea6132f15e9b5d47eb94f88547f79}{glfwGetVideoModes}}(monitor,\ \&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a619bc20e8198de3bd3f3d7fc34de66b2}{count}});}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{width\_mm}},\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{height\_mm}};}
\DoxyCodeLine{\mbox{\hyperlink{group__monitor_gad0e93a9e42b32394369cabbbdc1ab702}{glfwGetMonitorPhysicalSize}}(monitor,\ \&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{width\_mm}},\ \&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{height\_mm}});}
...
For more information on what the content scale is and how to use it, see \doxysectlink{window_guide_window_scale}{window content scale}{2}.\hypertarget{monitor_guide_monitor_pos}{}\doxysubsection{\texorpdfstring{Virtual position}{Virtual position}}\label{monitor_guide_monitor_pos}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ xpos,\ ypos,\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a6879d830f164725df67adeeabca3ea47}{width}},\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a60075de22f90a1223dc0bea98d2ee4d5}{height}};}
\DoxyCodeLine{\mbox{\hyperlink{group__monitor_ga5a3ac0f6e3786df47aabccfb5760b31d}{glfwGetMonitorWorkarea}}(monitor,\ \&xpos,\ \&ypos,\ \&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a6879d830f164725df67adeeabca3ea47}{width}},\ \&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a60075de22f90a1223dc0bea98d2ee4d5}{height}});}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a5c4947d4516dd7cfa3505ce3a648a4ef}{name}}\ =\ \mbox{\hyperlink{group__monitor_ga6d0ee079c807cd123b56dc3fc01e8fd9}{glfwGetMonitorName}}(monitor);}
...
The gamma ramp of a monitor can be set with \doxylink{group__monitor_gac9f36a1cfa10eab191d3029ea8bc9558}{glfw\+Set\+Gamma\+Ramp}, which accepts a monitor handle and a pointer to a \doxylink{structGLFWgammaramp}{GLFWgammaramp} structure.


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{structGLFWgammaramp}{GLFWgammaramp}}\ ramp;}
\DoxyCodeLine{\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{short}\ red[256],\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_aef30e4e3dccbffce99b7509d5366faef}{green}}[256],\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_ab4fcc6ff520ae4d9de259c8468a5cd93}{blue}}[256];}
\DoxyCodeLine{}
...
\DoxyCodeLine{ramp.\mbox{\hyperlink{structGLFWgammaramp_acea1bf88573f37cb0583a0fc005bbd0c}{green}}\ =\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_aef30e4e3dccbffce99b7509d5366faef}{green}};}
\DoxyCodeLine{ramp.\mbox{\hyperlink{structGLFWgammaramp_abd4ac5a186d9c000b9313099898df32a}{blue}}\ =\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_ab4fcc6ff520ae4d9de259c8468a5cd93}{blue}};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordflow}{for}\ (\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{i}}\ =\ 0;\ \ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{i}}\ <\ ramp.\mbox{\hyperlink{structGLFWgammaramp_ad620e1cffbff9a32c51bca46301b59a5}{size}};\ \ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{i}}++)}
\DoxyCodeLine{\{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const}\ \mbox{\hyperlink{structGLFWgammaramp}{GLFWgammaramp}}*\ ramp\ =\ \mbox{\hyperlink{group__monitor_gafe7b41852c1a14fe978f0e5381969885}{glfwGetGammaRamp}}(monitor);}
