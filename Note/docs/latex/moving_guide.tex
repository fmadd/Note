...
{\bfseries{Removed functions}} \begin{quote}
{\ttfamily glfw\+Read\+Image}, {\ttfamily glfw\+Read\+Memory\+Image}, {\ttfamily glfw\+Free\+Image}, {\ttfamily glfw\+Load\+Texture2D}, {\ttfamily glfw\+Load\+Memory\+Texture2D} and {\ttfamily glfw\+Load\+Texture\+Image2D}. \end{quote}
...
{\bfseries{Old syntax}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{GLFWCALL}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{callback\_function}}(...);}
...
{\bfseries{New syntax}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{callback\_function}}(...);}
...
{\bfseries{Old basic full screen}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{glfwOpenWindow}}(640,\ 480,\ 8,\ 8,\ 8,\ 0,\ 24,\ 0,\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{GLFW\_FULLSCREEN}});}

\end{DoxyCode}


{\bfseries{New basic full screen}} 
\begin{DoxyCode}{0}
...
{\bfseries{Old basic viewport setup}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga7feb769ebb3f3d21579b5a3fb07be76e}{glfwGetWindowSize}}(\&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a6879d830f164725df67adeeabca3ea47}{width}},\ \&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a60075de22f90a1223dc0bea98d2ee4d5}{height}});}
...
{\bfseries{New basic viewport setup}} 
\begin{DoxyCode}{0}
...
{\bfseries{Old basic main loop}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{while}\ (\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{glfwGetWindowParam}}(\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{GLFW\_OPENED}}))}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
...
The close callback no longer returns a value. Instead, it is called after the close flag has been set, so it can optionally override its value, before event processing completes. You may however not call \doxylink{group__window_ga806747476b7247d292be3711c323ea10}{glfw\+Destroy\+Window} from the close callback (or any other window related callback).

{\bfseries{Old syntax}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{GLFWCALL}}\ window\_close\_callback(\textcolor{keywordtype}{void});}
...
{\bfseries{New syntax}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{character\_callback}}(\mbox{\hyperlink{group__window_ga3c96d80d363e67d13a41b5d1821f3242}{GLFWwindow}}*\ window,\ \textcolor{keywordtype}{int}\ character);}
...
{\bfseries{Old syntax}} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{GLFWCALL}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{mouse\_wheel\_callback}}(\textcolor{keywordtype}{int}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{position}});}
...
{\bfseries{Removed functions}} \begin{quote}
{\ttfamily glfw\+Get\+Mouse\+Wheel} \end{quote}
