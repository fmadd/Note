...
All link-\/time dependencies for GLFW are already listed in the {\itshape Additional Dependencies} option by default.\hypertarget{build_guide_build_link_mingw}{}\doxysubsection{\texorpdfstring{With Min\+GW-\/w64 and GLFW binaries}{With MinGW-w64 and GLFW binaries}}\label{build_guide_build_link_mingw}
...
If you are using the static library version of GLFW, add it and the Cocoa, Open\+GL, IOKit and Quartz\+Core frameworks to the project as dependencies. They can all be found in {\ttfamily /\+System/\+Library/\+Frameworks}.\hypertarget{build_guide_build_link_osx}{}\doxysubsection{\texorpdfstring{With command-\/line or makefile on mac\+OS}{With command-line or makefile on macOS}}\label{build_guide_build_link_osx}
