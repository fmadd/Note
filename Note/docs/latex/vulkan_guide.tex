...
\end{DoxyItemize}\hypertarget{vulkan_guide_vulkan_loader}{}\doxysection{\texorpdfstring{Finding the Vulkan loader}{Finding the Vulkan loader}}\label{vulkan_guide_vulkan_loader}
...
@macos GLFW will also look up and search the {\ttfamily Frameworks} subdirectory of your application bundle.

If your code is using a Vulkan loader with a different name or in a non-\/standard location you will need to direct GLFW to it. Pass your version of {\ttfamily vk\+Get\+Instance\+Proc\+Addr} to \doxylink{init_8c_a1712210f34c339a05adda69e3587ec00}{glfw\+Init\+Vulkan\+Loader} before initializing GLFW and it will use that function for all Vulkan entry point retrieval. This prevents GLFW from dynamically loading the Vulkan loader.
...
@macos To make your application be redistributable you will need to set up the application bundle according to the LunarG SDK documentation. This is explained in more detail in the \href{https://vulkan.lunarg.com/doc/sdk/latest/mac/getting_started.html}{\texttt{ SDK documentation for mac\+OS}}.\hypertarget{vulkan_guide_vulkan_include}{}\doxysection{\texorpdfstring{Including the Vulkan header file}{Including the Vulkan header file}}\label{vulkan_guide_vulkan_include}
To have GLFW include the Vulkan header, define \doxylink{build_guide_GLFW_INCLUDE_VULKAN}{GLFW\+\_\+\+INCLUDE\+\_\+\+VULKAN} before including the GLFW header.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{vulkan_8h_a00f4dadde12c1a1f1b3c32f176adfb95}{PFN\_vkCreateInstance}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{pfnCreateInstance}}\ =\ (\mbox{\hyperlink{vulkan_8h_a00f4dadde12c1a1f1b3c32f176adfb95}{PFN\_vkCreateInstance}})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{vulkan_8h_a8a541401813275b44363efed3223a8c5}{PFN\_vkCreateDevice}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{pfnCreateDevice}}\ =\ (\mbox{\hyperlink{vulkan_8h_a8a541401813275b44363efed3223a8c5}{PFN\_vkCreateDevice}})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{vulkan_8h_aa4959e0564d6e486d19974a30aca323d}{PFN\_vkGetDeviceProcAddr}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{pfnGetDeviceProcAddr}}\ =\ (\mbox{\hyperlink{vulkan_8h_aa4959e0564d6e486d19974a30aca323d}{PFN\_vkGetDeviceProcAddr}})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{uint32\_t}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a619bc20e8198de3bd3f3d7fc34de66b2}{count}};}
\DoxyCodeLine{\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}**\ extensions\ =\ \mbox{\hyperlink{group__vulkan_gada152edc5bbbd0c2138728878632fd9c}{glfwGetRequiredInstanceExtensions}}(\&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a619bc20e8198de3bd3f3d7fc34de66b2}{count}});}
...
If successful the returned array will always include {\ttfamily VK\+\_\+\+KHR\+\_\+surface}, so if you don\textquotesingle{}t require any additional extensions you can pass this list directly to the {\ttfamily \doxylink{structVkInstanceCreateInfo}{Vk\+Instance\+Create\+Info}} struct.


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{structVkInstanceCreateInfo}{VkInstanceCreateInfo}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{ici}};}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{memset}}(\&\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{ici}},\ 0,\ \textcolor{keyword}{sizeof}(\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{ici}}));}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{ici}}.enabledExtensionCount\ =\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a619bc20e8198de3bd3f3d7fc34de66b2}{count}};}
\DoxyCodeLine{\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{ici}}.ppEnabledExtensionNames\ =\ extensions;}
\DoxyCodeLine{...}

\end{DoxyCode}


Additional extensions may be required by future versions of GLFW. You should check whether any extensions you wish to enable are already in the returned array, as it is an error to specify an extension more than once in the {\ttfamily \doxylink{structVkInstanceCreateInfo}{Vk\+Instance\+Create\+Info}} struct.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if}\ (\mbox{\hyperlink{vulkan_8c_a6a7033429666ac6b31d4250aeb5b37d1}{glfwGetPhysicalDevicePresentationSupport}}(instance,\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{physical\_device}},\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{queue\_family\_index}}))}
\DoxyCodeLine{\{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga69c40728499720bef8a49aa925ea0efa}{glfwWindowHint}}(\mbox{\hyperlink{group__window_ga649309cf72a3d3de5b1348ca7936c95b}{GLFW\_CLIENT\_API}},\ \mbox{\hyperlink{glfw_2include_2GLFW_2glfw3_8h_a8f6dcdc968d214ff14779564f1389264}{GLFW\_NO\_API}});}
...
\DoxyCodeLine{\mbox{\hyperlink{vulkan_8h_abe3614d1bd40772bc2398a4a86ea4a45}{VkResult}}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{err}}\ =\ \mbox{\hyperlink{vulkan_8c_a5a47c783767442b8b8e9ab3cf2e4959b}{glfwCreateWindowSurface}}(instance,\ window,\ \mbox{\hyperlink{tinycthread_8c_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}},\ \&surface);}
\DoxyCodeLine{\textcolor{keywordflow}{if}\ (\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a1e3b09934060e9d373139c3557730d37}{err}})}
\DoxyCodeLine{\{}
